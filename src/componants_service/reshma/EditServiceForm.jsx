...
export default function EditServiceForm2() {
  ...
  return (
    <div className="w-full h-full p-3 bg-gray-300 item-center">
      <div className="w-[100%] mt-1 flex gap-5 flex-col justify-center">
        ...
        <div className="relative w-[95%] self-center h-12">
          <select
            value={service.status}
            onChange={(e) => handleChange("status", e.target.value)}
            className="w-full h-full bg-black text-center text-white rounded-lg shadow outline-none px-3 cursor-pointer appearance-none"
          >
            <option className="text-green-600">Active</option>
            <option className="text-red-600">Disabled</option>
          </select>

          <span className="absolute inset-y-0 right-1/2 translate-x-16 flex items-center text-white pointer-events-none">
        ...
        <div className="w-[95%] self-center">
          <button
            ...
            className="w-[100%] h-12 self-center bg-black text-white border-none cursor-pointer rounded-lg shadow cursor-pointer"
          >
            Add Leads Balance <span className="p-2">+</span>
          </button>
        </div>


        <div className="w-[95%] self-center flex flex-col gap-2">
          <input
            value={service.title}
        ...
        <div className="w-[95%] self-center bg-gray-300">
        ...
        <div className="w-[95%] self-center flex justify-between font-bold text-sm">
  ...
  className={`self-center w-[95%] h-12 rounded-full shadow font-bold
    ${
