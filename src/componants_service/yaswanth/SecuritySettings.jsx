...
const SecuritySettings = () => {
  ...
  return (
    <section className="flex-1 w-full bg-white flex flex-col px-6 md:px-20 py-10">
      <div className="w-full  mx-auto flex-1 flex flex-col justify-between">
        ...
        <div className="space-y-10">
          ...
          {/* Updated Google Authenticator Row */}
          <button className="w-full flex items-center justify-between text-xl md:text-2xl font-medium py-6 text-gray-800 border-b border-gray-100">
            ...
            {/* text-6xl: Increases the size significantly 
                text-black: Ensures it stays black
                font-bold: Makes the arrow thicker so it looks bigger
            */}
