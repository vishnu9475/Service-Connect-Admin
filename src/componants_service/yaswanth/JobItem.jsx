...
export default function JobItem() {
  ...
  return (
   <div className="relative bg-white rounded-2xl shadow-[0_4px_6px_rgba(75,75,75,0.45)] p-15 w-[75%] mx-auto px-8 mt-4">
     ...
     {/* -----------------------button ------------------- */}
      <button className="mt-4 w-[25%] bg-green-700 text-white text-sm shadow-lg rounded-full flex justify-center text-center mx-auto py-1 px-6 relative cursor-pointer">
        Complete Payment
