...
export default function VerifyForgotPassword({ onBack }) {
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 space-y-6 flex-1 w-full py-6">
      <div className="w-full text-center mt-[5%]">
        ...
        <div className="w-full sm:w-[90%] md:w-[70%] mx-auto px-2 py-2 mb-2 space-y-3">
          <Link to="/page10a">
          <button className="w-full flex items-center justify-center bg-[#1D1F2A] text-white font-semibold py-3 px-6 rounded-full shadow-md relative hover:bg-[#232738] transition">
            <span>Verify</span>
