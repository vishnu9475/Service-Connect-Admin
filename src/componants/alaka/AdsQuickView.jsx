...
// const ads = [
//   { name: "Ad1", value: "1,456", label: "Total Reach", percent: "26%", action: "Clicks" },
//   { name: "Ad2", value: "1,456", label: "Total Reach", percent: "26%", action: "Clicks" },
//   { name: "Boosted Profile", value: "1,456", label: "Total Order", percent: "26%", action: "Clicks" },
// ];

// function AdsQuickView() {
//   const navigate = useNavigate();

//   return (
//     <div className="w-full bg-white rounded-2xl shadow-sm p-6">
//       <h2 className="text-[#303972] font-semibold mb-6">Ads</h2>

//       <div className="space-y-6">
//         {ads.map((ad, index) => (
//           <div
//             key={index}
//             onClick={() => navigate("/AdsManagement")}
...
//               <p className="text-[#303972] font-medium">{ad.name}</p>
//             </div>
...
//               </div>
//               <div>
//                 <p className="text-[#303972] font-semibold text-sm">{ad.value}</p>
//                 <p className="text-xs text-gray-400">{ad.label}</p>
//               </div>
//             </div>
...
//               <div>
//                 <p className="text-[#303972] font-semibold text-sm">{ad.percent}</p>
//                 <p className="text-xs text-gray-400">{ad.action}</p>
//               </div>
//             </div>
//           </div>
//         ))}
