  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm w-full p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-[#303972] font-semibold">
          Registered Services
        </h2>
        ...
        <Link
          to="/Category"
          className="flex items-center gap-1 text-blue-600 font-medium hover:text-blue-600"
        >
          View More
          <ArrowRightIcon className="w-4 h-4 text-blue-600 !text-blue-600" />
        </Link>
      </div>
