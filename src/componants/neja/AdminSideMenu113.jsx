...
const menuData = [
  ...
  { id: 9, label: "Profile", icon: FiUser, path: "/adminprofile" },
  { id: 10, label: "Chat", icon: FiMessageSquare, path: "/adminmessages" },
  { id: 11, label: "Settings", icon: FiSettings, path: "/generalsettings" },

  {
    ...
    icon: FiGrid,
    children: [
      { id: "12-1", label: "Service Type", path: "/servicetypedetails" },
      {
        id: "12-2",
        label: "Category",
        children: [
          { id: "12-2-1", label: "Categories", path: "/category" },
          { id: "12-2-2", label: "Sub Category", path: "/subcategory" },
        ],
      },
    ],
  },
