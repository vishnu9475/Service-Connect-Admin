...
const ServiceProviderDetails133 = ({
  name = "Rahul Service Provider",
  id = "#Id:3543324",
  status = "Active",
...
export default ServiceProviderDetails133;