      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <div className="flex gap-2 relative">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 sm:px-6 py-1.5 text-xs border border-[#6C63FF] text-[#6C63FF] rounded-full"
          >
          ...
          <button className="flex items-center gap-2 px-4 sm:px-6 py-1.5 text-xs bg-[#6C63FF] text-white rounded-full">
            Main <FiChevronDown size={12} />
          </button>
        </div>
      </div>
